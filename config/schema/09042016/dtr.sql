...
insert  into `acos`(`id`,`parent_id`,`model`,`foreign_key`,`alias`,`lft`,`rght`) values (1,NULL,'User',NULL,'User',1,2),(2,NULL,'Document',NULL,'Document',3,4),(3,NULL,'Student201',NULL,'Student201',5,6),(4,NULL,'Attendance',NULL,'Attendance',7,8),(5,NULL,'User',NULL,'User',9,10);
