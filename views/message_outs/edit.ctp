...
<?php echo $this->Form->create('MessageOut');?>
	<fieldset>
		<legend><?php __('Edit Message Out'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('MessageOut.Id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('MessageOut.Id'))); ?></li>
