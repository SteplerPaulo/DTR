				...
				<fieldset>
					<legend><?php __('Allow Permission'); ?></legend>						
						<?php
							...
							echo $this->Form->input('users',array('required'=>'required','between'=>'<div class="controls">','after'=>'</div>'));
							echo $this->Form->input('models',array('required'=>'required','between'=>'<div class="controls">','after'=>'</div>'));
						?>
				</fieldset>				
