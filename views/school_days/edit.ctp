...
<?php echo $this->Form->create('SchoolDay');?>
	<fieldset>
		<legend><?php __('Edit School Day'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('SchoolDay.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('SchoolDay.id'))); ?></li>
