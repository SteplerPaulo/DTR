...
<div ng-controller="FetcherAssigningController" ng-init="initializeController()">
	
	<section class="row" ng-if="RFIDENTRY"><br/><br/>
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-default">
					<div class="panel-heading">ASSIGN RFID</div>
					<div class="panel-body">
						<?php echo $this->Form->input('source_rfid',array('class'=>'form-control inline input-sm','label'=>false,'placeholder'=>'RFID','ng-model'=>'RFID'));?>
					</div>
					<div class="panel-footer">	
						<div class="text-right">
							<button class="btn btn-default" type="reset">Reset</button>
							<button class="btn btn-warning" ng-click="GoButton(RFID)">Go</button>
						</div>
					</div>
				</div>
			</div>
	...
	<section class="row" ng-if="ASSIGNING">
		<div class="col-md-4">
			<div class="panel panel-default">
		...
		<div class="col-md-4">
			<div class="login-panel panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-4" ng-repeat="(k,d) in FINALFETCHERS" ng-if="isSelected[d.Fetcher.slug]">
							<a class="thumbnail">
					...
					<div class="row">
						<div class = "col-md-4" ng-repeat="(k,d) in FINALSTUDENTS" ng-if="isSelected[d.RfidStudent.slug]">
							<div class="thumbnail">
					...
					<div class="row hide">
						<div class="col-md-7">
							<?php echo $this->Form->input('source_rfid',array('class'=>'form-control inline input-sm','label'=>'RFID','placeholder'=>'RFID','required'=>'required','ng-value'=>'{{RFID}}'));?>
						</div>
					</div>
				</div>
				<div class="panel-footer">	
				...
				<div class="panel-body">
					...
					<div class="list-group">
						<div class="list-group-canvas list-group-search-results">
							...
							<a class="list-group-item" pagination-id="StudentList" dir-paginate="d in students | filter:StudentFilter | itemsPerPage: pageSize" ng-click="studentSelected(d)" ng-hide="isSelected[d.RfidStudent.slug]">
								<h5 class="list-group-item-heading">
