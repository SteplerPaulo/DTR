						...
						<tr ng-repeat="(k,d) in students | filter:q">
							...
							<td class="text-right">
								<div class="btn-group-vertical">
									<button type="button" class="btn btn-xs btn-default" ng-class="d.Attendance.Remarks == 'P'?'active':''">Present</button>
									<button type="button" class="btn btn-xs btn-default" ng-class="d.Attendance.Remarks == 'A'?'active':''">Absent</button>
								</div>
							</td>
						</tr>
					</tbody>
			...
			<div class="col-lg-2 col-md-2 col-sm-2" ng-repeat="d in students | filter:q">
				<div class="thumbnail">
					...
					<div class="caption" style="height:110px">
						...
						<div class="btn-group">
							<button type="button" class="btn btn-sm btn-default" ng-class="d.Attendance.Remarks == 'P'?'active':''">Present</button>
							<button type="button" class="btn btn-sm btn-default" ng-class="d.Attendance.Remarks == 'A'?'active':''">Absent</button>
						</div>
					</div>
				</div>
			</div>
