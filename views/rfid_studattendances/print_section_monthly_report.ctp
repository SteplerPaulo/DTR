		...
		<div class="col-lg-6 col-lg-offset-3">
			<div class="panel panel-default">
				<div class="panel-heading">
					<span class="panel-title">Print Section Monthly Report</span>
				</div>
				...
				<div class="panel-footer text-right">
					<a ng-disabled="!selected || !date" href="/DTR/rfid_studattendances/monthly_report/{{selected.Section.id}}/{{selected.Section.name}}/{{date}}" target="_blank" class="btn btn-primary">Go</a>
				</div>
			</div>
		</div>
	</section>
