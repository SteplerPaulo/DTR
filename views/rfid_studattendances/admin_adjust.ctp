<div ng-controller="StudentAttendanceAdjustmentController" ng-init="initializeController()">
	<div class="row-fluid">
		...
		<div class="col-lg-12">
			<table class="table table-bordered" id="AdjustmetTable">
				<caption style="padding-bottom:10px;">
					<h3 sno="<?php echo $sno;?>" fromdate="<?php echo $fromDate; ?>" todate="<?php echo $toDate; ?>">
						<span class="pull-left" id="StudentName"><?php echo $sname; ?></span>				
					</h3><br/>
				</caption>
				<thead>
					<tr>
				...
				<tbody>
					<tr pagination-id="AdjustmetTable" dir-paginate="d in data | filter:q | itemsPerPage: pageSize" current-page="currentPage">
						...
						<td class="text-center">{{d.rfid_studattendance.remarks}}</td>
...
<?php echo $this->Html->script('controllers/per_student_adjustment',array('inline'=>false));?>